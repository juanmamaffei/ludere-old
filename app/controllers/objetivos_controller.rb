class ObjetivosController < ApplicationController
  ...
  def set_mision
    ...
    def objetivo_params
      params.require(:objetivo).permit(:mision_id, :nombre, :descripcion, :habilitado, :visible, :urlvideoinstructivo, :urlpdfinstructivo, :urlhtmlinstructivo, :descripcioninstructivo, :urlvideoevaluativo, :urlpdfevaluativo, :urlhtmlevaluativo, :descripcionevaluativo)
    end
end
